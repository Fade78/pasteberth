...
The external-consumer recipe and Python example describe the published 2.1.22
contract. Serve the script as downloadable source, never as server-executed code.
