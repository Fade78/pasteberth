...
for idx,snippet in enumerate(json.loads((ROOT/'qa/work/generated-configs.json').read_text())):
 with tempfile.TemporaryDirectory(prefix='config-',dir=ROOT/'qa/work') as td:
...
report['generated_configs_sha256']=hashlib.sha256((ROOT/'qa/work/generated-configs.json').read_bytes()).hexdigest()
